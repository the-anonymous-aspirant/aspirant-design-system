...
export const specimens = () => [
  ...
  h(DS.AspBadge, { variant: 'chip', removable: true }, () => 'removable chip'),
  ...
  h(DS.AspTextarea, { label: 'textarea label', modelValue: 'typed value' }),
...
export const injectProbeCss = () => {
  ...
  // out the surface below it — twice, once on the click and once on the hover,
  // having been diagnosed as a slow probe the first time.
  //
